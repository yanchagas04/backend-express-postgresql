...
<div align="center" style="display: flex; justify-content: center; align-items: center; gap: 40px; margin: 20px 0;">
  ...
  <img src="https://miro.medium.com/v2/resize:fit:720/format:webp/1*iNVrmliw1DH1O3Wx2m_ggA.gif" alt="PostgreSQL" height="60" style="height:120px; object-fit: contain;">
  <img src="https://jwt.io/img/logo-asset.svg" alt="JWT" height="60" style="height: 120px; object-fit: contain;">
</div>
